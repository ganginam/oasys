package com.oasys.admin.reply.controller;
...
public class ReplyController {
	...
	@DeleteMapping(value = "/{qa_num}/{r_num}", produces = {MediaType.TEXT_PLAIN_VALUE})
	public ResponseEntity<String> replyDelete(@PathVariable("r_num") Integer r_num, @PathVariable("qa_num") Integer qa_num){
		log.info("replyDelete 호출 성공");
		
		int result = replyService.replyDelete(r_num, qa_num);
