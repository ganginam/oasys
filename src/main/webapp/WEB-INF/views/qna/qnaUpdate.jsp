...
<html>
			...
			$(function(){
				...
				$("#faqUpdateBtn").click(function(){
					if(!chkSubmit($('#fa_type'), "분류를")) return;
						...
						$("#fa_updateForm").attr({
							"method":"post",
							"action":"/faq/faqUpdate"
						});
						$("#fa_updateForm").submit();
					}
				});
				
				/* 취소 버튼 클릭 시 처리 이벤트 */
				$("#faqCancelBtn").click(function(){
					$("#fa_updateForm").each(function(){
						this.reset();
					});
				});
	...
	<body>
		<div class="contentContainer container-fluid">
			<div class="contentTit page-header"><h3 class="text-center">수정</h3></div>
			
			<div class="contentTB text-center">
				<form id="fa_updateForm" name="fa_updateForm">
					...
					<table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td>분류</td>
								<td class="text-left">${updateData.fa_type}</td>
							</tr>
							<tr>
								<td>제목</td>
								<td colspan="3" class="text-left">${updateData.fa_title}</td>
							</tr>
							<tr>
								<td>내용</td>
