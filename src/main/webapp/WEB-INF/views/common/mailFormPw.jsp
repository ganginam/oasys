   ...
   <head>
      ...
      var value = "";
      		...
      		$("#btn_codeCheck").click(function(){
      			if($("#code").val().replace(/\s/g,"")==""){
      				...
      				//codeCheck().then(function(data){
      					console.log(value);
      					if(value==$("#code").val()){
							alert("[성공]\n코드가 일치합니다.\n새로운 비밀번호를 메일로 전송하였습니다. 다시 로그인해주세요");
							window.close();
							window.open("/common/pwChange", "비밀번호 변경", "width=400, height=300, left=100, top=50")
						}else{
							alert("[실패]\n코드가 일치하지않습니다.");
      	...
      	function getParentText(){
      		//var sum_email = "";
      		document.getElementById("tomail").value = opener.document.getElementById("searchPw_email").value;
      	}
   </script>
   </head>
	<body>
