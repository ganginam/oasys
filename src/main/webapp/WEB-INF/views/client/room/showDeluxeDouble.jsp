...
<html>
	...
	<div class="location">
                <ul>
                    ...
                    <li><a href='#'>객실</a></li>
                    <li class="current"><a href='/roomGrade/showDeluxe'>디럭스 트윈룸</a></li>
                </ul>
                <h1>오아시스 객실 상세보기</h1>
    </div>
	...
	<div class="sub-section">
		<p class="paragraph">
			<em>디럭스 프리미엄</em>은 비즈니스를 목적으로 하는 투숙객에게 최적의 객실입니다.<br>
			나무 등 자연 요소를 모티브로 한 가구 디자인과 효율적인 동선배치는 디럭스 프리미엄은 가장 합리적이면서도<br>
			스타일리시한 객실로 만들어 줍니다.
		</p>
	</div>
	<div class="sub-section">
