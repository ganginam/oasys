...
<html>
   <head>
     ...
     <script type="text/javascript">
           ...
           $(function(){
              ...
              $(document).on("click", "button[data-button='insertBtn']", function(){
            	//입력 유효성 체크
        			...
        			else if(!checkForm("#r_content", "댓글내용을")) return;
           ...
           // 댓글 등록 메서드
           function addItem(r_num, r_name, r_title, r_content, r_date){
              var wrapper_div = $("<div>");
              ...
              name_span.html(r_title+"&nbsp;&nbsp;&nbsp;"+ r_name + "님")
              ...
              upBtn.addClass("btn btn-default gap btn-sm");
              upBtn.html("수정하기");
              ...
              delBtn.addClass("btn btn-default gap btn-sm");
              delBtn.html("삭제하기");
           ...
           function listAll(qa_num){
              $("#reviewList").html("");
              var url = "/replies/all/" + qa_num + ".json";
              ...
              $.getJSON(url, function(data){
                 ...
                 $(data).each(function(){
         			...
         			addItem(r_num, r_name, r_title, r_content, r_date);
                 });
              }).fail(function(){
           ...
           //삭제를 위한 Ajax 연동 처리
           function deleteBtn(qa_num, r_num){
              if(confirm("선택하신 댓글을 삭제하시겠습니까?")){
                 $.ajax({
                    url : '/replies/'+qa_num+'/' +r_num,
                    type : 'delete',
                    headers : {
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="comment_form" name="comment_form">
						...
						<div class="form-group">
							<label for="r_title" class="control-label">제목</label>
							<input type="text" class="form-control" name="r_title" id="r_title" maxlength="15" />
						</div>
						<div class="form-group">
							<label for="r_content" class="control-label">내용</label>
