	...
	<head>
		...
		$(function () {
			...
			$("#insertFormBtn").click(function () {
				...
				location.href = "/admin/notice/noticeWriteForm"+queryString;
			});
	...
	<body>
		<div class="contentContainer container-fluidA">
				...
				<table class="table table-bordered">
					...
					<tbody id="list" class="table-striped">
						<c:choose>
							...
							<c:otherwise>
								<tr>
									<td class="text-center" colspan="4">등록된 게시물이 존재 하지않습니다.</td>
								</tr>			
							</c:otherwise>
						</c:choose>	
					</tbody>
			...
			<div class="text-right">
				<input type="button" value="글쓰기" id="insertFormBtn" class="btn btn-default btn-lg">
			</div>
		</div>
	</body>
</html>